...
# Check that creating and destroying datasets with files that have
# attributes do not cause the depletion of the storage pool space.
#
# @parameter: $1 the pool from which to draw the test file systems
# @return: 0 if all the work completed OK.
# @use: TOTAL_COUNT log_note log_assert
