...
#
# DESCRIPTION:
#	'zfs recv -FK' destroy file systems and do not destroy
...
#	13. Destination filesystem: force-keep receive (-FK) incremental
#	    replication stream.
#	14. Destination filesystem: make sure that only child filesystems
#	    'fs2', 'fs3' and all recursive snapshots 'snap1', 'snap2' and
#	    'snap3' are exists.
#
...
log_assert "'zfs receive -FK' destroy file systems and do not destroy " \
	"snapshots that do not exist on the sending side."
log_onexit cleanup
